...
//
    ...
    open class PluggableSceneDelegate: UIResponder, SceneDelegate {
        ...
        private func applyToScene<T, S>(
            _ work: (SceneService, @escaping (T) -> Void) -> S?,
        ...
        open func scene(
            ...
            __sceneServices
                .forEach { $0.scene?(scene, didFailToContinueUserActivityWithType: userActivityType, error: error) }
        }
    ...
    extension PluggableApplicationDelegate {
        ...
        open func application(
            ...
            print(
                "[PluggableApplicationDelegate] - Any service implement \(#function). Return a default configuration"
            )
